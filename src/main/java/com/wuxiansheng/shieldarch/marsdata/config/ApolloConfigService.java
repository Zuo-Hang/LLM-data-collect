...
public class ApolloConfigService {
     ...
     * 配置命名空间常量
     */
    public static final String OCR_LLM_CONF = "OCR_LLM_CONF";
    public static final String PRICE_FITTING_CONF = "PRICE_FITTING_CONF";
    public static final String QUALITY_MONITOR_CONF = "QUALITY_MONITOR_CONF";
    public static final String OCR_BUSINESS_CONF = "OCR_BUSINESS_CONF";
