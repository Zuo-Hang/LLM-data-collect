error id: file://<WORKSPACE>/src/main/java/com/wuxiansheng/shieldarch/marsdata/io/PoiService.java:_empty_/MetricsClientAdapter#
file://<WORKSPACE>/src/main/java/com/wuxiansheng/shieldarch/marsdata/io/PoiService.java
empty definition using pc, found symbol in pc: _empty_/MetricsClientAdapter#
empty definition using semanticdb
empty definition using fallback
non-local guesses:

offset: 1026
uri: file://<WORKSPACE>/src/main/java/com/wuxiansheng/shieldarch/marsdata/io/PoiService.java
text:
```scala
...
public class PoiService {
    ...
    @Autowired(required = false)
    private MetricsCl@@ientAdapter metricsClient;
